...
#ifndef CHARACTER_DESPAWN_EMITTER_3D_H
#define CHARACTER_DESPAWN_EMITTER_3D_H

#include "Emitter_3D.h"
#include <array>

struct CharacterDespawnEmitter_3D : public Emitter_3D
{
#define waypoint_Index 4

	CharacterDespawnEmitter_3D();
