...
Weather_Rain_Emitter_3D::Weather_Rain_Emitter_3D()
{
	...
	m_MM.m_maxParticles = 5000;

	m_EM.m_spawnTimeInterval = 0.16f;
	m_EM.m_spawnCountTimer = m_EM.m_spawnTimeInterval;
	m_EM.m_rateOverTime = 200;
	...
	m_PAM.m_velocityVariation = glm::vec3{ 30.0f, -100.0f, 0.0f };
	m_PAM.m_gravity = true;

	m_PAM.m_scaleBegin = glm::vec3{ 0.005f, 0.1f, 0.005f };
	//m_PAM.m_scaleBegin = glm::vec3{ 0.001f, 0.1f, 0.001f };
	m_PAM.m_scaleEnd = glm::vec3{ 0.0f, 0.0f, 0.0f };
	m_PAM.m_scaleVariation = glm::vec3{ 0.0f, 0.1f, 0.0f };
