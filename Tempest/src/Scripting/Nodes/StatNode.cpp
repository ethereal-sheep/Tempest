...
namespace Tempest
{
    ...
    node_ptr StatNode::create_node(const std::string& typeinfo)
    {
        ...
        case Tempest::StatNode::inner_type::SetStat:
            ...
            node.add_output(pin_type::Int, "new");
            break;
    ...
    script* StatNode::create_script(Entity entity [[maybe_unused]], Instance& instance [[maybe_unused]] )
    {
        ...
        */
                    ...
                    [&instance, entity, sid = stat_id](uint8_t index) {
                        ...
                        if (index == 0)
                        {
                            ...
                            if (auto owner = instance.srm.get_variable_to_id(entity, "Owner"))
                            {
                                ...
                                {
                                    auto stat = character->get_stat(sid) + character->get_statDelta(sid);
        ...
        case Tempest::StatNode::inner_type::SetStat:
            return instance.srm.add_script(
                CreateRuntimeScript<std::tuple<int>(int, uint8_t)>(
                    [&instance, entity, sid = stat_id](int x, uint8_t index) {
                        ...
                        if (index == 0)
                        {
                            ...
                            if (auto owner = instance.srm.get_variable_to_id(entity, "Owner"))
                            {
                                ...
                                if (auto character = instance.ecs.get_if<tc::Character>(own_e))
                                {
                                    auto& s = character->get_stat(sid);
                                    auto& d = character->get_statDelta(sid);
        ...
        case Tempest::StatNode::inner_type::SetMain:
            return instance.srm.add_script(
                CreateRuntimeScript<std::tuple<int>(int, uint8_t)>(
                    [&instance, entity](int x, uint8_t index) {
        ...
        case Tempest::StatNode::inner_type::ResetStat:
            return instance.srm.add_script(
                CreateRuntimeScript<std::tuple<int>(uint8_t)>(
                    [&instance, entity, sid = stat_id](uint8_t index) {
...
//
//    
//    std::string ReduceStatNode::get_type_string()
//    {
//        // assuming no problem
//        std::string toReturn = magic_enum::enum_name(type).data();
//        toReturn += ":";
...
//    }
//
//    node_ptr ReduceStatNode::create_node(const std::string& typeinfo)
//    {
//        auto v = algo::delimited_split(typeinfo, ":");
//        if (v.size() != 2)
//        {
...
//        }
//        // attacker/defender | stat_id
//        auto type = magic_enum::enum_cast<ReduceStatNode::inner_type>(v[0]);
//
//        if (!type.has_value())
//        {
//            throw node_exception("SetStatNode: Bad inner type!");
...
//
//        // we cannot check if stat exist here so we assume it does
//        ReduceStatNode node(type.value());
//        node.set_name(v[1]);
//        node.add_input(pin_type::Flow, "");
//        node.add_input(pin_type::Int, "");
//        node.add_output(pin_type::Flow, "");
//        node.add_output(pin_type::Int, "");
//
//        return make_sptr<ReduceStatNode>(std::move(node));
//    }
//
//    script* ReduceStatNode::create_script(Entity entity [[maybe_unused]], Instance& instance [[maybe_unused]] )
//    {
//        /* steps:
//        1. from name derive
//            stat name
...
//        switch (type)
//        {
//        case Tempest::ReduceStatNode::inner_type::Owner:
//            return instance.srm.add_script(
...
//                        if (auto character = instance.ecs.get_if<tc::Character>(atk_e))
//                        {
//                            auto& stat = character->get_statDelta(sid);
//                            return stat -= x;
//                        }
//                        return 0;
//                    }, std::placeholders::_1));
//            break;
//        case Tempest::ReduceStatNode::inner_type::Enemy:
//            return instance.srm.add_script(
//                CreateRuntimeScript<std::tuple<int>(int)>(
//                    [&instance, entity, sid = stat_id](int x) {
//
...
//
//
//    std::string RestoreStatNode::get_type_string()
//    {
//        // assuming no problem
//        std::string toReturn = magic_enum::enum_name(type).data();
//        toReturn += ":";
...
//    }
//
//    node_ptr RestoreStatNode::create_node(const std::string& typeinfo)
//    {
//        auto v = algo::delimited_split(typeinfo, ":");
//        if (v.size() != 2)
//        {
...
//        }
//        // attacker/defender | stat_id
//        auto type = magic_enum::enum_cast<RestoreStatNode::inner_type>(v[0]);
//
//        if (!type.has_value())
//        {
//            throw node_exception("SetStatNode: Bad inner type!");
...
//
//        // we cannot check if stat exist here so we assume it does
//        RestoreStatNode node(type.value());
//        node.set_name(v[1]);
//        node.add_input(pin_type::Flow, "");
//        node.add_input(pin_type::Int, "");
//        node.add_output(pin_type::Flow, "");
...
//    }
//
//    script* RestoreStatNode::create_script(Entity entity [[maybe_unused]], Instance& instance [[maybe_unused]] )
//    {
//        /* steps:
//        1. from name derive
//            stat name
...
//        switch (type)
//        {
//        case Tempest::RestoreStatNode::inner_type::Owner:
//            return instance.srm.add_script(
//                CreateRuntimeScript<std::tuple<int>(int)>(
//                    [&instance, entity, sid = stat_id](int x) {
//
...
//                    }, std::placeholders::_1));
//            break;
//        case Tempest::RestoreStatNode::inner_type::Enemy:
//            return instance.srm.add_script(
//                CreateRuntimeScript<std::tuple<int>(int)>(
//                    [&instance, entity, sid = stat_id](int x) {
//
...
//                            {
//                                auto sid = weapon->get_main_stat();
//                                return  weapon->get_stat(sid) + character->get_stat(sid) + character->get_statDelta(sid);
//                            }
//                        }
//                        return 0;
//                    }));
