...
namespace Tempest
{
    class AddUnitsPopup : public Window
    {
        ...
        {
            Service<EventManager>::Get().register_listener<AddingUnitsTrigger>(&AddUnitsPopup::open_popup, this);
        }
        ...
        void show(Instance& instance) override
        {
            ...
            if (enable_popup)
            {
                ...
                if (ImGui::BeginPopupModal("Add Units", NULL, flags))
                {
                    ImVec2 winMin = { ImGui::GetWindowPos().x, ImGui::GetWindowPos().y };
                    ImVec2 TextMin = { ImGui::GetWindowPos().x + 10.f, ImGui::GetWindowPos().y + 5.f };
                    ImVec2 winMax = { winMin.x + ImGui::GetWindowWidth() * 0.3f, winMin.y + ImGui::GetWindowHeight() * 0.05f };
                    ...
                    auto img = tex_map["Assets/Charac.dds"];
                    auto halfToneImg = tex_map["Assets/HalftoneWhite.dds"];
                    ImVec2 imgMin = { winMin.x + ImGui::GetWindowWidth() * 0.1f, winMin.y + ImGui::GetWindowHeight() * 0.1f };
